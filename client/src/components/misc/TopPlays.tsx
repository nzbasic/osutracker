        ...
        <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-1 min-w-0">
                {playsHistory[index].scores.sort((a,b) => parseFloat(b.pp) - parseFloat(a.pp)).map((item, index) => (
                    <div key={index} className={`${item.added && 'dark:text-green-400 bg-green-400'} flex  justify-between dark:bg-dark03 border border-black rounded p-1 text-tiny md:text-base`}>
