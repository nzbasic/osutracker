...
export default function UserDetails({ data }) {
  ...
  return (
    <div className="bg-main-one dark:bg-gray-700 dark:text-white flex-wrap rounded-md p-4 xl:mt-4 mb-2 mx-2 shadow-lg flex mt-14 md:mt-16 text-xs md:text-sm">
